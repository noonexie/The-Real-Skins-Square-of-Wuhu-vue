<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="dataType" label="类型" width="100" sortable>
      </el-table-column>
  ...
  try {
    ...
    if (data) {
      ...
      for (let index = 0; index < state.tableData.length; index++) {
        ...
        if (element.dataType == "video") element.dataType = "影视";
        if (element.dataType == "journey") element.dataType = "旅行";
        if (element.dataType == "book") element.dataType = "书籍";
