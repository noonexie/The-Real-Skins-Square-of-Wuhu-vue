<template>
  ...
  <el-table :data="state.rspResources" stripe style="width: 100%">
    <el-table-column label="开始时间" slot-scope="scope">
      <template #default="scope">
        {{ scope.row.FileName }}
      </template>
    </el-table-column>
    <el-table-column label="终止时间" width="300">
      <template #default="scope">
        {{ scope.row.AlbumName }}
      </template>
    </el-table-column>
    <el-table-column label="用户" width="100" slot-scope="scope">
      <template #default="scope">
        <el-button
          type="primary"
          @click="
    ...
    <el-table-column label="可做事项" width="350" slot-scope="scope">
      <template #default="scope">
