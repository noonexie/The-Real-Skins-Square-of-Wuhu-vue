<template>
  <div>
    ...
    <el-form
      ...
      :size="formSize"
    >
      <el-form-item label="旅行名称" prop="dataName">
...
const rules = reactive({
  dataName: [
    { required: true, message: "请输入您推荐的旅行名称", trigger: "blur" },
    // { min: 3, max: 5, message: 'Length should be 3 to 5', trigger: 'blur' },
  ],
  dataUrl: [
    { required: true, message: "请输入您推荐旅行的网址", trigger: "blur" },
  ],
  dataText: [
    { required: true, message: "请输入您推荐旅行的上榜理由", trigger: "blur" },
  ],
});
